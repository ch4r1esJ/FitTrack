...
☁️ Completed workouts automatically sync to Fitness app and Firebase
...
🗑️ Delete templates
✏️ Update templates
▶️ Start workouts from templates

🏋️ Create Template / Exercise Selection
...
⚙️ Set number of sets, reps, and weights for each exercise
...
⏸️ Rest timer automatically initiates after each set (customizable by user)
...
⏸️ Minimize workout (pauses the exercise)
❌ Dismiss or finish workout
☁️ Completed workouts sync to Firebase and Fitness app
